...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('songs', [\App\Http\Controllers\API\SongsController::class, 'store']);
    Route::delete('songs/{id}/{user_id}/', [\App\Http\Controllers\API\SongsController::class, 'destroy']);
